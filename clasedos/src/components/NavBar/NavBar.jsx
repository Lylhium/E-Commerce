      ...
      <Toolbar>
         <Typography variant="h6">
           ...
           <Link to='/'> <img  src= {Logo} alt={'logoMain'}/> </Link>
              ...
              <li> <Link to='/productos' style={{ textDecoration: 'none',color:'white'}}> <Button color="inherit">Productos</Button>
            ...
            <li><Link to='/contacto' style={{ textDecoration: 'none',color:'white'}}> <Button color="inherit">Contacto</Button></Link></li> 
              ...
              <Link to='/cart'style={{ textDecoration: 'none',color:'white'}}> <FontAwesomeIcon icon={faCartPlus}/> </Link>
               </div>
        </Toolbar>
 </AppBar>
      );
